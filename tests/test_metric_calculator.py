...
class TestMetricCalculator(unittest.TestCase):
  ...
  def testCalculate(self):
    ...
    self.assertEqual(int(non_metrics_df['annotatable_elements']), 10)
    self.assertEqual(non_metrics_df['annotated_elements'][0], None)
    self.assertEqual(float(non_metrics_df['coverage']), 0.0)
    self.assertEqual(non_metrics_df['consistent_elements'][0], None)
